	...
	var main = function($el){
		...
		if($firstP){
			...
			var phrases = [
				...
				'I implore you',
				'I reckon',
				'It is with great sorrow that I must say',
...
// Viva LA revolution
			...
			var phrases = [
				...
				'And so it goes.',
				'And so the sun went down on another day, and our heroes went back to their ordinary lives.  Until they ride again.  May we all be glad that they are out there, being vigilant.',
